# 1 SOAL TERJAWAB DENGAN BENAR MENDAPATKAN 10 POINT
# TOTAL SOAL ADA 10
# Write in Visual Studio Memek 

# VERSI 1.0
# AKAN ADA PEMBARUAN TAPI GATAU KAPAN
# MENGGUNAKAN PYTHON 3.6.6

# Ide: Alwan Putra 
# Penulis Code: XXXXXXXXX
